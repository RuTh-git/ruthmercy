...
const workItems = [
  {
    ...
    company: 'Accenture',
    date: '2021 – 2022',
    description: 'Built scalable backend APIs and internal automation tools.',
  ...
  },
  {
    ...
    company: 'SIUE',
    date: '2022 – 2023',
    description: 'Helped students learn data structures and Python coding.',
  ...
  },
  {
    ...
    date: '2023 – Present',
    description: 'Building AI-powered dashboards, portfolios, and web apps.',
